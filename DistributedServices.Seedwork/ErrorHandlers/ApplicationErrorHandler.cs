// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ApplicationErrorHandler.cs" company="">
//   
// </copyright>
// <summary>
...
namespace Phoenix.PhoenixApp.DistributedServices.Seedwork.ErrorHandlers
{
    ...
    using Phoenix.PhoenixApp.DistributedServices.Seedwork.Resources;
    ...
    public sealed class ApplicationErrorHandler : IErrorHandler
    {
        ...
        /// </param>
        /// <param name="fault">
        /// The System.ServiceModel.Channels.Message object that is returned to the client, or service in duplex case
        /// </param>
        public void ProvideFault(Exception error, MessageVersion version, ref Message fault)
        {
            if (error is FaultException<ApplicationServiceError>)
            {
                ...
                fault = Message.CreateMessage(
                    version, messageFault, ((FaultException<ApplicationServiceError>)error).Action);
            }
            else
            {
                // create service error
                var defaultError = new ApplicationServiceError { ErrorMessages = new[] { Messages.message_DefaultErrorMessage } };
